...
{\it Institut ``Jožef Stefan'', Ljubljana}\\
 ...
 Risbe in diagrami: Mojca Vilfan\linebreak[1] % Risbe in diagrami
 
 Oblikovanje, postavitev in prelom: Mojca Vilfan \linebreak[1] %Design

 Besedilo še ni bilo jezikovno pregledano.\linebreak[1]
 
 Naslovne slike poglavij: Mojca Vilfan, Martin Rigler (stran 199)\\ % Fotografije
...
dovoljeno samo z odobritvijo avtorjev knjige.} \linebreak[1]% Printing/edition date
 ...
 \textsc{Ljubljana, 2022}\linebreak[1]
...
%\input{Chapter_12_OpticneNaprave}
%\input{Chapter_13_Ucni_Listi}
