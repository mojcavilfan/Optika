...
Atomi v votlini se nahajajo v različnih diskretnih energijskih stanjih,
...
\beq
\frac{N_2}{N_1} = \frac{N_0e^{-E_2/k_BT}}{N_0e^{-E_1/k_BT}} = e^{-(E_2-E_1)/k_BT},
\label{eq:11_01}
\eeq
...
zapišemo kot:
\beq
\varrho (k) = \frac{4 \pi k^2}{8 (\pi/L)^3} \frac{2}{L^3}\qquad \mathrm{oziroma}\qquad
\varrho (\omega) = \frac{4 \pi \omega^2}{8c^3 (\pi/L)^3}\frac{2}{L^3} = 
