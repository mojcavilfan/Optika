...
ki so večji od mejnega kota totalnega odboja $\alpha_m$, se svetloba totalno odbije.}
...
Amplituda jakosti električnega polja pojema eksponentno
...
\cos \left( k_0 n_1 x\sin \alpha -i \omega t\right). 
\label{eq:04_64}
\eeq
...
Celotno polje v snovi z večjim lomnim količnikom zapišemo kot:
\begin{align}
