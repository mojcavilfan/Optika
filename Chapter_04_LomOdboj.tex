...
Dva izmed najosnovnejših optičnih pojavov sta odboj in lom valovanja ni meji
...
meji dveh snovi odbija in lomi. Vemo, da je odbojni kot enak vpadnemu (enačba~\ref{eq:odbojnizakon}), 
...
\label{eq:04_02}
\eeq
pri čemer vektor $\mathbf{s}_0 $ opisuje normalo na ploskev kvadra in hkrati na mejno ravnino. 
...
\begin{figure}[ht]
\centering
%\includegraphics[width=10truecm]{slike/04_PolarizacijaFoto.jpg}
...
\begin{figure}[ht]
\centering
%\includegraphics[width=10truecm]{slike/04_MavricaFoto.jpg}
...
Odbito polje je pri totalnem odboju do faze natačno enako vpadnemu, le smer $k_z$ se spremeni. 
