...
valovne vektorje vpadne, odbite in prepuščene svetobe kot:\index{Valovni vektor}
\begin{align}
...
relativni amplitudi odbite in prepuščene svetlobe, imenujemo Fresnelovi enačbi. 
...
\label{eq:04_26}
\eeq
Vpeljemo amplitudno odbojnost $r = E_{0r}/E_{0i}$ \index{Odbojnost!amplitudna}
...
$r$ z uporabo lomnega zakona (enačba~\ref{eq:04_18}) preoblikujemo:\index{Prepustnost!amplitudna}
\beq
...
\label{eq:04_28}
\eeq
Amplitudna prepustnost je tako:\index{Fresnelove enačbe}
\boxeq{eq:TEt}{
...
razmerje med odbito in vpadno amplitudo jakosti električnega polja. Dobimo Fresnelovo enačbo:\index{Odbojnost!amplitudna}\index{Fresnelove enačbe}
\boxeq{eq:TMr}{
...
dobimo iz enačbe~(\ref{eq:04_31}):\index{Fresnelove enačbe}\index{Prepustnost!amplitudna}
\boxeq{eq:TMt}{
...
močjo. To razmerje ni enako razmerju gostot svetlobih tokov, saj se zaradi\index{Prepustnost}
...
od vpadnega kota (slika~\ref{fig:04_redte}\,a). \index{Odbojnost!amplitudna}\index{Prepustnost!amplitudna}
...
\index{Polarizacija!{transverzalna magnetna}}\index{Odbojnost!amplitudna}\index{Prepustnost!amplitudna}
...
valovanje enaka nič, imenujemo Brewstrov kot $\alpha_B$ po škotskem \index{Brewstrov kot}
\index{Brewster, David}
...
ali popolnem odboju. Mejni kot totalnega odboja izračunamo kot:\index{Totalni odboj}\index{Mejni kot totalnega odboja}
\boxeq{eq:totalni}{
