...
\begin{remark}
Uklonski integral je prvotno zapisal Fresnel,\index{Fresnel, Augustin} vendar je namesto predfaktorja 
...
(slika~\ref{fig:05_ravnivalovi}).\index{Približek daljnega polja|see{Fraunhoferjev uklon}}
\begin{figure}[h]
\centering
...
naj bo enaka $z_0'$ (slika~\ref{fig:05_Fresnel}).\index{Objektna ravnina}\index{Opazovalna ravnina}
\begin{figure}[ht]
\centering
\def\svgwidth{120truemm} 
