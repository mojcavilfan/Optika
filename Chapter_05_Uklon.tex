...
ravno, velja $E(\mathbf{r}) = E_0$ za vsak $\mathbf{r}$. Za nastanek slike
...
Prvi oklepaj imenujemo oblikovni faktor $S(\vartheta)$ in določa ovojnico 
...
Primer je narisan za $N=5$ rež in $D=3d$. Oblikovni faktor $S$ (modra) je 
enak kot uklonska slika ene reže. Produkt med oblikovnim in mrežnim
...
Produkt med oblikovnim faktorjem $S$ (modra) in mrežnim
...
se začnejo prispevki odštevati in skupno polje zmanjševati (desno).}
