...
V drugi polovici sedemnajstega stoletja so Grimaldi\footnote{~Italijanski\index{Grimaldi, Francesco Maria}
...
da valovna dolžina valovanja svetlobi določa barvo.\index{Euler, Leonhard Paul}
...
Fresnel\footnote{~Francoski fizik Augustin Jean Fresnel, 1788--1827.}\index{Fresnel, Augustin Jean}
...
na tem področju je prispeval Maxwell\footnote{~Škotski fizik James Clerk Maxwell,\index{Maxwell, James Clerk}
...
1888 ponudil Hertz\footnote{~Nemški fizik\index{Hertz, Heinrich Rudolf}
...
Fran\c{c}ois}\index{Fresnel, Augustin Jean}\index{Fizeau, Armand}\index{Airy, Sir 
...
Abraham Michelson, 1852--1931.} s svojim\index{Michelson, Albert Abraham}
...
in Kirchhoff\footnote{~Nemški fizik Gustav Robert Kirchhoff, 1824--1887.}\index{Kirchhoff, Gustav Robert}
