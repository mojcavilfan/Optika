...
Koherenca\index{Koherenca} oziroma koherentne lastnosti svetlobe se nanašajo na obstoj povezave
med fazo elektromagnetnega\index{Faza valovanja} valovanja na nekem kraju ob nekem času ter njegovo 
...
v obliki (enačba~\ref{eq:ravnival}):\index{Jakost električnega polja}
\begin{equation}
...
\section{Časovna koherenca}\index{Koherenca!{časovna}}
...
\begin{itemize}
 \item popolnoma koherentno valovanje,\index{Koherenca!{popolna}} 
 ...
 \item delno koherentno, za katerega velja:\index{Koherenca!{delna}}
\begin{equation}
...
\label{eq:08_04}
\end{equation}
Do časa $\tau_c$, ki ga imenujemo koherenčni čas, fazo valovanja\index{Koherenčni čas}
poznamo, pri daljših časih pa ni povezave med fazo valovanja. Večina
realnih optičnih sistemov je delno koherentnih.
 \item nekoherentno valovanje, za katerega velja, da\index{Nekoherentno valovanje}
...
z\index{Interferometer!{Michelsonov}}\index{Michelsonov interferometer}
...
vpadom na detektor ponovno združita. Če v postavitev dodamo kolimator,\index{Kolimacija} 
ki iz izvorne svetlobe naredi širok vzporeden snop, dobimo tako imenovano
Twyman-Greenovo postavitev (slika~\ref{fig:08_Twyman}).\index{Interferometer!{Twyman-Greenov}}
\index{Twyman-Greenov interferometer}
\begin{figure}[ht]
\centering
...
\index{Časovna avtokorelacijska funkcija!{za periodični signal}}
\boxeq{eq:G1}{
...
\index{Koherenčna dolžina} je koherenčna dolžina $L_c = c \tau_c$.
}
\label{fig:08_sinkoh}
\vglue-7truemm
\end{figure}
...
\index{Časovna avtokorelacijska funkcija!{za neperiodični signal}}
...
Namesto koherenčnega časa $\tau_c$ pogosto vpeljemo koherenčno dolžino\index{Koherenčna dolžina}
$L_c = c_0 \tau_c$, ki označuje pot, ki jo svetloba prepotuje 
v koherenčnem času. Časovno koherenco zato imenujemo tudi
\index{Koherenca!{longitudinalna}|see{časovna}}
\index{Koherenca!{vzdolžna}|see{časovna}}
...
\section{Wiener-Hinčinov izrek}\index{Wiender-Hinčinov izrek}
...
Vpeljemo spekter svetlobe $S(\omega)$\index{Spekter} kot intenziteto svetlobe pri $\omega$ na frekvenčni 
...
polja:\index{Wiender-Hinčinov izrek}
\boxeq{eq:WH}{
...
(1894--1959).\index{Wiener, Norbert}\index{Hinčin, Aleksander Jakovljevič}
...
\begin{example}{\bf Spekter ravnega valovanja.}\index{Spekter!{ravnega valovanja}}
...
\begin{example}{\bf Spekter omejenega ravnega valovanja.}\index{Spekter!{omejenega ravnega valovanja}}
...
svetlobno moč na enoto frekvenčnega intervala, pri neperiodičnih pa energijo.\index{Spekter!{neperiodičnega signala}}
...
\section{Prostorska koherenca}\index{Koherenca!{prostorska}}
...
na različnih krajih.\index{Koherenca!{prečna}|see{prostorska}}\index{Koherenca!{transverzalna}|see{prostorska}}
...
in $\mathbf{r}_2$ ob času $t$. Kadar sta fazi valovanja na obeh krajih povezani in velja:\index{Faza valovanja}
\begin{equation}
\phi(\mathbf{r}, t) =  f(\mathbf{r}_2-\mathbf{r}_1, t, \phi(\mathbf{r}_1, t)),
\label{eq:08_28}
\end{equation}
pravimo, da sta točki $\mathbf{r}_1$ in $\mathbf{r}_2$ na isti koherenčni ploskvi.\index{Koherenčna ploskev}
Če fazi $\phi(\mathbf{r}_1, t)$ in $\phi(\mathbf{r}_2, t)$ med seboj nista povezani, ležita
na različnih koherenčnih ploskvah. 

Prostorsko koherenco analiziramo z Youngovim poskusom (glej poglavje~\ref{chap:Young}),\index{Youngov poskus}
pri katerem svetlobo usmerimo na objektni zaslon\index{Objektni zaslon} z dvema majhnima odprtinama in opazujemo 
interferenčno sliko na oddaljenem zaslonu.\index{Opazovalni zaslon} Svetilo, s katerega vpada svetloba na odprtini,
naj bo razsežno. Ko sta odprtini v objektnem zaslonu zelo blizu skupaj, na oddaljenem zaslonu 
nastane značilna interferenčna slika. Z večanjem razmika med odprtinama se kontrast 
interference na zaslonu zmanjšuje. Ko popolnoma zbledi, je razmik med odprtinama enak 
prečni koherenčni razdalji vpadnega valovanja.\index{Koherenčna razdalja}
...
vpada na opazovalni zaslon na oddaljenosti $z_0$ od objektnega zaslona (slika~\ref{fig:08_kohprost}). 
Privzamemo, da velja $D \ll z_0, z_0'$.
\begin{figure}[ht]
\centering
\def\svgwidth{120truemm} 
\input{slike/08_kohprost.pdf_tex}
\caption{Z Youngovim poskusom analiziramo prostorsko koherenco svetila. Z večanjem razmika med
režama $D$ se kontrast interferenčne slike na opazovalnem zaslonu spreminja. Razmik med režama,
pri katerem interferenčni vzorec izgine, določa prečno koherenčno razdaljo. 
}
\label{fig:08_kohprost}
\vskip-2truemm
\end{figure}

Žarki, ki izhajajo iz ene točke svetila, po prehodu skozi reži 
med seboj interferirajo. Kadar je svetilo razsežno, za vsako točko izvora
nastane interferenčni vzorec in na zaslonu zaznamo 
superpozicijo interferenčnih vzorcev z različnih 
delov svetila. Na opazovalnem zaslonu si izberemo točko, ki je simetrična glede na reži 
...
razlikujeta (slika~\ref{fig:08_kohprost}). Njuna fazna razlika je: 
\begin{equation}
...
določa transverzalno koherenčno razdaljo svetlobe, ki vpada na objektni 
zaslon.\index{Koherenčna razdalja} Parameter $D_c^2$\index{Vidljivost}
je merilo za velikost koherenčne ploskve vpadne svetlobe.\index{Koherenčna ploskev} 
...
\begin{example}{\bf Merjenje velikosti zvezd.}\index{Youngov poskus}
...
omogoča določiti velikost zvezde.\index{Michelsonov zvezdni interferometer}\index{Interferometer!{Michelsonov zvezdni}}
\begin{figure}[ht]
\centering
\def\svgwidth{80truemm} 
...
Z opisano postavitvijo sta leta 1920 Michelson\index{Michelson, Albert Abraham} 
in astronom Francis Gladheim Pease\index{Pease, Francis Gladheim}
...
\section{Van Cittert-Zernikov izrek}\index{Van Cittert-Zernikov izrek}
...
je pri časovni koherenci kontrast\index{Vidljivost} interferenčnih prog sorazmeren z avtokorelacijsko funkcijo polja
(enačba~\ref{eq:G12}). Nadalje velja, da je kontrast interferenčnih prog sorazmeren z 2D-Fourierevo
transformiranko intenzitetne porazdelitve na oddaljenem izvoru. Z inverzno transformacijo lahko iz izmerjenega
...
in nizozemskem fiziku in nobelovcu Fritsu Zerniku (1888--1966).\index{van Cittert, Pieter Hendrik}
\index{Zernike, Frits}

Naj svetloba s svetila vpada na objektni zaslon,\index{Objektni zaslon} v katerem sta dve odprtini, 
na oddaljenem opazovalnem zaslonu\index{Opazovalni zaslon} pa opazujemo interferenčno sliko 
(slika~\ref{fig:08_VCZ}). Svetloba, ki vpada 
...
Na oddaljenem zaslonu opazujemo interferenčno sliko v odvisnosti od razmika med 
odprtinama. Ko razmik doseže koherenčno razdaljo, kontrast interferenčnih prog izgine.}
\label{fig:08_VCZ}
\vskip-4truemm
\end{figure}
...
časih meritve:\index{Navzkrižna korelacijska funkcija}
\boxeq{eq:CC}{
...
\label{eq:08_38}
\end{equation}
je odvisen od prostorske koherence valovanja in določa kontrast\index{Vidljivost}
oziroma vidljivost\index{Vidljivost} interferenčne slike
...
še razliki koordinat\index{Van Cittert-Zernikov izrek}
...
\section{Holografija}\index{Holografija}
Za konec si na kratko oglejmo še holografijo -- to je zapisovanje interferenčnega vzorca v medij
in rekonstrukcija 3D slike predmeta. Hologram zapišemo tako, da snop monokromatske\index{Hologram}
...
opazujemo v odbiti svetlobi.\index{Hologram!mavrični}
\begin{figure}[!h]
\centering
...
\begin{remark}
Kadar zajamemo interferenco ne le v tankem filmu, temveč po debelejšem sloju, imenujemo\index{Hologram!volumski}
