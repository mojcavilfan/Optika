...
\caption{Odboj svetlobe na tanki plasti dielektrika debeline $d$ (a).
...
odbito na prvi meji, interferira z delnim valovanjem, odbitim na drugi meji. Za
izračun fazne razlike med njima si pomagamo s sliko~\ref{fig:06_plast}\,b.
...
za ojačitve in oslabitve odbitega valovanja je zato treba 
...
pri čemer je $N$ poljubno celo število. 
\begin{remark}
...
oslabitve zamenjana glede
na izraza, izpeljana za simetrični primer (enačbi~\ref{eq:06_tankamax} in 
\ref{eq:06_tankamin}).
\end{remark}

\begin{example}{\bf Interferenca na tanki plasti}.
Interferenco na tanki plasti lahko pogosto opazujemo tudi v naravi, na primer
na tanki plasti olja na luži ali na milnem mehurčku. Tanka plast olja na 
vodni gladini je navadno izredno enakomerno debela plast, tanka 
...
V prejšnjih razdelkih smo obravnavali interferenco dveh delnih valovanj, ki sta nastali
ali z delitvijo valovne fronte ali delitvijo amplitude. Zdaj se osredotočimo
na interferenco zelo velikega števila delnih valovanj, ki nastanejo
z delitvijo amplitude. Tak primer je interferenca na tanki plasti dielektrika.

Naj ravno valovanje vpada na tanko plast snovi z lomnim količnikom $n_2$, lomni količnik 
okolice pa naj bo enak $n_1$. Omejimo se na primer TE polariziranega valovanja, pri katerem
je smer jakosti električnega polja pravokotna na vpadno ravnino (slika~\ref{fig:06_plast}).
