...
(slika~\ref{fig:06_Michelson}).
Gostota svetlobnega toka na detektorju je (enačba~):
\beq
j = 4j_0 \cos^2(\Delta \phi/2),
\label{eq:06_24}
\eeq
pri čemer je $\Delta \phi = k_0(l_1-l_2)$. Maksimumi so doseženi pri:
\beq
k_0 \Delta l 2/2 = N \pi
\eeq
oziroma:
\beq
\Delta l = \frac{N\pi}{k_0} = N\lambda/2.
\eeq
...
zrcalom razdelimo na dva dela. Delni valovanji se odbijeta od zrcal 
in interferirata na detektorju oziroma zaslonu. V eno ..krilo?... interferometra
navadno dodamo kompenzator, da izniči učinek prehoda drugega žarka skozi stekleni del zrcala. 
}
