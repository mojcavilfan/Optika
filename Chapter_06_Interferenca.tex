...
\beq
\mathbf{k}_1 = (k_x,0, k_z) \qquad \mathrm{in} \qquad \mathbf{k}_2 = (-k_x,0, k_z).
\label{eq:06_13}
\eeq
Valovanji sta potem oblike:
\beq
E_1 = e^{ik_x x} e^{ik_z z}e^{-i\omega t} \qquad \mathrm{in} \qquad 
...
j_0 \frac{4 \sin^2(kD\sin\vartheta/2)\cos^2(kD \sin\vartheta/2)}{×\sin^2(kD \sin\vartheta/2)}
 = 4j_0 \cos^2\left(\frac{kD \sin\vartheta}\right){2},
\label{eq:06_23}
\eeq
