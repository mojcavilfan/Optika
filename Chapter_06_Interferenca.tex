...
% Robni pogoji (enačba~\ref{eq:RPE}) zahtevajo, 
% da se na meji ohranja tangentna komponenta jakosti električnega polja. Ker je
% vpad pravokotnen, se ohranja celotna jakost električnega polja. Tako dobimo
% prvo zvezo:
% \beq
% \tilde{E}_1 + \tilde{E}_1' = E_2 + E_2'.
% \label{eq:06_52}
% \eeq
...
\begin{example}{\bf Fabry-Perotov etalon v matrični obravnavi.}
...
\frac{n_3}{n_1}\frac{t_{12}^2t_{23}^2}{1+ r_{12}^2r_{23}^2+2r_{12}r_{23}\cos\phi},
\label{eq:06_72}
\eeq
...
\beq
2 \frac{2\pi}{\lambda} n_2 d = \pi \qquad \Longrightarrow \qquad d = \frac{\lambda}{4n_2} = \frac{\lambda_2}{4}.
\label{eq:06_73}
\eeq
...
n_2 = \sqrt{n_1n_3} \qquad \mathrm{in} \qquad d = \frac{\lambda_2}{4}.
}
...
\begin{example}{\bf Periodične strukture in fotonski kristali.}
